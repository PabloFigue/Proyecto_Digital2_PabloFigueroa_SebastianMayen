...
void DS3231_Set_Date_Time(uint8_t dy, uint8_t mth, uint8_t yr, uint8_t dw, uint8_t hr, uint8_t mn, uint8_t sc)
{
    ...
    I2C_Master_Write(DS3231_Bin_Bcd(sc));
    I2C_Master_Write(DS3231_Bin_Bcd(mn));
    I2C_Master_Write(DS3231_Bin_Bcd(hr));
    I2C_Master_Write(DS3231_Bin_Bcd(dw));
    I2C_Master_Write(DS3231_Bin_Bcd(dy));
    I2C_Master_Write(DS3231_Bin_Bcd(mth));
    I2C_Master_Write(DS3231_Bin_Bcd(yr));
    I2C_Master_Stop();
}
